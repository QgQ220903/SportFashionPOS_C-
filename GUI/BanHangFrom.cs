...
namespace WindowsFormsApp3.GUI
{
    ...
    public partial class BanHangFrom : Form
    {
        ...
        internal void AddCTHD(SanPham sp, String ms, String kc, int soLuong, float thanhTien, String ctsp)
        {
        ...
        private void addToDGVOrder(String ctsp, SanPham sanPham, String ms, String kc, int soluong, float thanhtien)
        {
        ...
        private ChiTietHoaDon createCTHD(int maCTSP, SanPham sp, String ms, String kc, int soLuong, float thanhTien)
        {
