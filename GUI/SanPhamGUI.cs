    ...
    public partial class SanPhamGUI : Form
    {
        ...
        private void danhSachSanPham_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            else if (selectedColumnName == "ChiTiet")
            {
                ...
                chiTietSanPhamGUI.danhSachChiTietSanPham.Columns["Sua"].Visible = chiTietQuyenBUS.kiemTraHanhDong(this.MaNhomQuyen, this.MaChucNang, "Sửa");
                chiTietSanPhamGUI.danhSachChiTietSanPham.Columns["Xoa"].Visible = chiTietQuyenBUS.kiemTraHanhDong(this.MaNhomQuyen, this.MaChucNang, "Xóa");
