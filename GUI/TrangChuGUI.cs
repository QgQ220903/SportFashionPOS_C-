...
namespace GUI
{
    public partial class TrangChuGUI : Form
    {
        ...
        public TrangChuGUI(int maTaiKhoan, int maNhomQuyen, List<string> danhSachTenChucNang)
        {
            ...
            btnTrangChu.Size = new System.Drawing.Size(300, 55);
            btnTrangChu.Padding = new System.Windows.Forms.Padding(10, 0, 0, 0);
            btnTrangChu.Font = new System.Drawing.Font("Segoe UI Variable", 10F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            btnTrangChu.ForeColor = System.Drawing.Color.White;
            ...
            btnTrangChu.Click += new EventHandler(Click);
            ...
            if (danhSachTenChucNang.Count > 0)
            {
                foreach (var item in danhSachTenChucNang)
                {
                    ...
                    btn.Size = new System.Drawing.Size(300, 55);
            ...
            btnDangXuat.Size = new System.Drawing.Size(300, 55);
        ...
        private void Click(object sender, EventArgs e)
        {
            ...
            {
                int maChucNang = chucNangBUS.LayChucNangQuaTen(check.Text).MaChucNang;
                sanPhamGUI = new SanPhamGUI(this.MaNhomQuyen, maChucNang);
                ...
                chiTietSanPhamGUI.danhSachChiTietSanPham.Columns["Sua"].Visible = chiTietQuyenBUS.kiemTraHanhDong(this.MaNhomQuyen, maChucNang, "Sửa");
                chiTietSanPhamGUI.danhSachChiTietSanPham.Columns["Xoa"].Visible = chiTietQuyenBUS.kiemTraHanhDong(this.MaNhomQuyen, maChucNang, "Xóa");
            ...
            else if (check.Text == "Nhập Hàng")
            {
                ...
                int maChucNang = chucNangBUS.LayChucNangQuaTen(check.Text).MaChucNang;
                phieuNhapGUI.btnShowDialog.Visible = chiTietQuyenBUS.kiemTraHanhDong(this.MaNhomQuyen, maChucNang, "Thêm");
                NhapHangTab nhapHangTab = new NhapHangTab(phieuNhapGUI);
