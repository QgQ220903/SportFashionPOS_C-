    ...
    public partial class SoLuongDonHangForm : Form
    {
        ...
        private void loadData()
        {
            ...
            */            //MessageBox.Show(ctsp + "");
            ...
            MauSacBUS mauSacBUS = new MauSacBUS();
            SanPhamBUS sanPhamBUS = new SanPhamBUS();
            this.lbKichCo.Text = kichCoBUS.LayKichCoQuaMaKhongXetTrangThai(chiTietSanPham.MaKichCo).TenKichCo;
            this.lbMauSac.Text = mauSacBUS.LayMauSacQuaMaKhongXetTrangThai(chiTietSanPham.MaMauSac).TenMauSac;
        ...
        private void btnTiepTuc_Click_1(object sender, EventArgs e)
        {
            if (!this.txtSoLuong.Text.Equals(""))
            {
                ...
                this.BanHangFrom.AddCTHD(this.sp, this.lbKichCo.Text.ToString().Trim(), this.lbMauSac.Text.ToString().Trim(), this.SoLuong, this.ThanhTien, this.mactsp + "");
                this.Dispose();
